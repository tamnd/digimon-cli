...
// HTTP behaviour is covered in digimon_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "digimon://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("digimon", "about")
	if err != nil || got.String() != "digimon://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want digimon://page/about", got.String(), err)
	}
}
