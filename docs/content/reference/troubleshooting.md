...
Most of these come down to network reality or how digimon serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

digimon rate-limits like any public site. digimon already paces
...
Where a surface is gated, digimon reads a cookie or token you supply
...
`digimon`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what digimon actually did
